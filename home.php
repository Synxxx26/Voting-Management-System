...
<div class="containe-fluid">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card col-md-4 offset-2 float-left" style="background-color:rgb(255, 118, 118) !important;" >
			...
			<div class="card col-md-4 offset-2 ml-4 float-left" style="background-color: #D483Ac !important;">
				<div class="card-body text-white">
					<h4><b>Voted</b></h4>
					<hr>
